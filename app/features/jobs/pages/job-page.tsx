        ...
        <div className="col-span-4 space-y-10">
          <div>
            <div className="rounded-full size-40 bg-white overflow-hidden relative left-10">
              <img src="https://github.com/apple.png" alt="Company Logo" className="object-cover" />
            </div>
          </div>
          <div>
          ...
          <div className="space-y-2.5">
            ...
            <p className="text-lg">
              Looking for a Software Engineer with 3 years of experience in React, Node.js, and MongoDB.
            </p>
          </div>
          <div className="space-y-2.5">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="text-lg list-disc list-inside">
              {["Health insurance", "401(k) retirement plan", "Paid time off"].map((item) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </div>
          <div className="space-y-2.5">
            ...
            <ul className="text-lg list-disc list-inside">
              {["React", "Node.js", "MongoDB", "TypeScript", "JavaScript"].map((item) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </div>
        </div>
        <div className="col-span-2 space-y-4 mt-32 sticky top-20 border rounded-lg p-6">
          <div className="flex flex-col">
            <span className="text-2xl font-medium">$100,000 - $120,000 per year</span>
          ...
          <div className="flex">
            <span className="text-sm text-muted-foreground">Posted 12 days ago</span>
